...
# Prior predictive distribution - fit prior model only and plot to check if prior expectations are reasonable --------------------------------------------------------------
...
#quick plot of prior predictive marginal distributions
